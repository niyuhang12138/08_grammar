...
fn parse_json(input: &str) -> Result<JsonValue> {
    let input = &mut (&*input);
    parse_value(input).map_err(|e: ContextError| anyhow!("Failed to parse JSON: {:?}", e))
}
...
mod tests {
    ...
    #[test]
    fn test_parse_null() -> winnow::Result<(), ContextError> {
        let input = "null";
    ...
    #[test]
    fn test_parse_bool() -> winnow::Result<(), ContextError> {
        let input = "true";
    ...
    #[test]
    fn test_parse_num() -> winnow::Result<(), ContextError> {
        let input = "123";
    ...
    #[test]
    fn test_parse_string() -> winnow::Result<(), ContextError> {
        let input = r#""hello""#;
    ...
    #[test]
    fn test_parse_array() -> winnow::Result<(), ContextError> {
        let input = r#"[1, 2, 3]"#;
    ...
    #[test]
    fn test_parse_object() -> winnow::Result<(), ContextError> {
        let input = r#"{"a": 1, "b": 2}"#;
